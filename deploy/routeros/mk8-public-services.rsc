...
add chain=dstnat action=dst-nat in-interface-list=WAN dst-address=@@MK8_PUBLIC_IPV4@@ protocol=tcp dst-port=25,80,110,443,465,587,993,995 to-addresses=@@MK8_SERVER_IPV4@@ comment="mk8 public TCP services" place-before=0
...
add chain=forward action=accept in-interface-list=WAN connection-nat-state=dstnat connection-state=new protocol=tcp dst-address=@@MK8_SERVER_IPV4@@ dst-port=25,80,110,443,465,587,993,995 comment="allow mk8 public TCP services" place-before=0
