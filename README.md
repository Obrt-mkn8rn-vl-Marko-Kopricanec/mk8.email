...
A self-hosted .NET 10 email and groupware server with JMAP as its default client protocol and secure IMAP, POP3, SMTP, CalDAV, and CardDAV compatibility for traditional clients such as Thunderbird.
